...
from . import auth
from ..models import User, Person,RoleType, Ticker
...
def dashboard():
    ...
    baseUrl = 'https://www.highcharts.com/samples/data/aapl-ohlcv.json'
    data = requests.get(baseUrl)
    if data:
        return render_template('auth/admin/dashboard.html',tickerList=tickerList, exchangeTypeList=exchangeTypeList,marketTypeList=marketTypeList,currencyTypeList=currencyTypeList, data=data.content)
    return render_template('auth/admin/dashboard.html',tickerList=tickerList, exchangeTypeList=exchangeTypeList,marketTypeList=marketTypeList,currencyTypeList=currencyTypeList)
